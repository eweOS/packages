...
{
  cd $pkgname-$pkgver
  sed -ie 's/test-c32ispunct.sh//' tests/Makefile.in
  sed -ie 's/test-malloc-gnu$(EXEEXT)//' tests/Makefile.in
  sed -ie 's/test-calloc-gnu$(EXEEXT)//' tests/Makefile.in
  sed -ie 's/test-realloc-gnu$(EXEEXT)//' tests/Makefile.in
}

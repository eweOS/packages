...
pkgbase=java23-openjdk
pkgname=('jre23-openjdk' 'jdk23-openjdk' 'openjdk23-src' 'openjdk23-doc')
...
makedepends=('java-environment>=22' 'java-environment<24' 'zip' 'libelf' 'libcups' 'alsa-lib'
...
sha256sums=('08c773325be3ce74605de24aa0adafda81814b116e8540afbb5c6d8e1e7b1fa0'
            ...
            '3dff5c18da1720e5122dea13c36710fcf17567568648fd7b93415c52e24ea41d'
            '873b16c50e8ef8fc930eb7a85bf7c79a0f6cdedf5f80bf5f34310a51513fc629'
...
prepare() {
  ...
  _patch_ $_jdkdir
  cd $_jdkdir
  sed -i 's@-fuse-ld=lld@-fuse-ld=mold@' make/autoconf/flags-ldflags.m4
}

...
pkgname=('jre-openjdk' 'jdk-openjdk' 'openjdk-src' 'openjdk-doc')
...
makedepends=('java-environment=22' 'zip' 'libelf' 'libcups' 'alsa-lib'
             'graphviz' 'freetype2' 'libjpeg' 'giflib' 'libpng' 'lcms2'
             'bash' 'harfbuzz' 'linux-headers')
optdepends=(
  'gvfs: open links e.g. hyperlinks'
)             
source=(https://github.com/openjdk/jdk${_majorver}u/archive/${_git_tag}.tar.gz no-x11.patch lfs64.patch install_openjdk.sh)
